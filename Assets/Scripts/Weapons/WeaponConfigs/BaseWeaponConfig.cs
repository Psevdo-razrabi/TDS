...
namespace Game.Player.Weapons.WeaponConfigs
{
    ...
    { 
        ...
        [field: SerializeField, Range(0,1000)] public int TotalAmmo { get; protected set; }
        ...
        [field: Header("Урон")]
        [field: SerializeField] public List<BodyTypeDamage> DamageSettings { get; protected set; }
